        ...
        <div className={`navbar ${isVisible ? 'navbar_visible' : 'navbar_hidden'}`}>
            <div className="nav_con">
                <div className='nav_item_set'>
                    <div className='brand-name'>DevLink</div>
                    <div className='nav_bar_item'>
                        ...
                        <p
                            className={`nav_nav_item ${currentPath === '/learningProgress' ? 'nav_nav_item_active' : ''}`}
                            onClick={() => (window.location.href = '/learningProgress')}
                        >
                            Learning Progress
                        </p>
                        {allRead ? (
