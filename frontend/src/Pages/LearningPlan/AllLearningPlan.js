        ...
        <div className='continSection'>
          <aside className='searchinput'>
            ...
            <div className='add_new_btn' onClick={() => (window.location.href = '/addLearningPlan')}>
              <IoIosCreate size={20} className='add_new_btn_icon' /> Create New Plan
            </div>
          </aside>
          ...
          <div className='post_card_continer'>
            {filteredPosts.length === 0 ? (
              <div className='not_found_box'>
                ...
                <p className='not_found_msg'>No learning plans found.</p>
                <button className='add_new_btn' onClick={() => (window.location.href = '/addLearningPlan')}>
                  <IoIosCreate size={20} /> Create New Plan
                </button>
              </div>
            ) : (
