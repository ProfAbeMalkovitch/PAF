      ...
      <div className="continSection">
        <aside className="searchinput">
          ...
          <div className='add_new_btn' onClick={() => navigate('/addNewPost')}>
            <IoIosCreate size={20} /> Create New Post
          </div>
        </aside>
        ...
        <div className='post_card_continer'>
          {filteredPosts.length === 0 ? (
            <div className='not_found_box'>
              ...
              <button className='not_found_btn' onClick={() => navigate('/addNewPost')}>Create New Post</button>
            </div>
          ) : (
      ...
      >
        ...
        {selectedMedia && (
          selectedMedia.endsWith('.mp4') ? (
            ...
            <img src={`http://localhost:8080${selectedMedia}`} alt="Media" />
          )
        )}
      </Modal>
    </div>
